...
class EcolabAuthenticationService
{
    /**
    ...
    use ConsumesExternalServices, InteractsWithEcolabResponses;

    public function __construct()
    {
        $this->baseUri = config('services.ecolab.base_uri');
        $this->clientId = config('services.ecolab.client_id');
        $this->clientSecret = config('services.ecolab.client_secret');
        $this->passwordClientId = config('services.ecolab.password_client_id');
        $this->passwordClientSecret = config('services.ecolab.password_client_secret');
    }
